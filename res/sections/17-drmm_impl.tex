...
Words that appear in similar contexts get pushed closer to each other
...
Additionaly, I tested my implementation with a different way to generate word embeddings, passing documents splitted at sentence-level to Word2Vec. The results were as follows:
