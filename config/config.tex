...
% Frontespizio
%**************************************************************
\newcommand{\myName}{Emanuele Carraro}                                    % autore
\newcommand{\myTitle}{A reproducibility study of a neural IR system}       % tipo di tesi
\newcommand{\mySupervisor}{Gianmaria Silvello}                        % relatore
\newcommand{\myCoSupervisor}{Alberto Purpura}                      % co-relatore
...
\newcommand{\myAA}{2018-2019}                                   % anno
\newcommand{\myTime}{July 2019}                             % quando
...
\addbibresource{res/bibliography.bib}
...
%--------------- END MULTI columns ---------------------------------------------
\tikzstyle{decision} = [diamond, draw, fill=white!20, text width=6em, text badly centered, node distance=3cm, inner sep=0pt]
\tikzstyle{block} = [rectangle, draw, fill=white!20, text width=6em, text centered, rounded corners, minimum height=4em]
\tikzstyle{line} = [draw, -latex']
\tikzstyle{cloud} = [draw, ellipse,fill=yellow!20, text width=3em, node distance=3cm, minimum height=2em]